...
for day in range(365):
    ...
    model.add_cpds(cpd_workstation, cpd_inventory_processor, cpd_tool_server, cpd_database)
...
plt.ylim(0, 0.005)  # Adjusted for better visualization of small probability changes
...
plt.savefig('Yearly_Database_Compromise_Probability2.png', format='png', dpi=300)  # Adjust dpi for higher resolution